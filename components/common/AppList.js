 ...
 * @param {Array} props.items - Itens da lista
 * @param {function} props.renderItem - Função para renderizar cada item
 * @param {boolean} props.loading - Se a lista está em estado de carregamento
 * @param {string} props.emptyMessage - Mensagem a ser exibida quando a lista estiver vazia
 * @param {boolean} props.divider - Se deve exibir divisores entre os itens
 * @param {Object} props.sx - Estilos adicionais para a lista
 ...
 * 
 * @param {Object} props - Propriedades do componente
 * @param {string} props.primary - Texto principal do item
 * @param {React.ReactNode} props.secondary - Texto secundário do item
 * @param {React.ReactNode} props.icon - Ícone do item
 * @param {React.ReactNode} props.avatar - Avatar do item
 * @param {React.ReactNode} props.action - Ação do item
 * @param {function} props.onClick - Função a ser chamada quando o item for clicado
 * @param {boolean} props.selected - Se o item está selecionado
 * @param {boolean} props.disabled - Se o item está desabilitado
 * @param {Object} props.sx - Estilos adicionais para o item
 * @returns {JSX.Element} Componente de item de lista
 */
export const AppListItem = ({
  ...
  // Estilos modernos para itens de lista
